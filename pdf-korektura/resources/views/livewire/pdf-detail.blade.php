<div>
    <div class="mb-6">
        <a href="{{ route('dashboard') }}" class="text-slate-600 hover:text-slate-900 text-sm">&larr; Zpět na dashboard</a>
    </div>
        ...
        <div class="lg:col-span-2">
            <div class="bg-white rounded-lg shadow p-6 mb-6">
                <div class="flex justify-between items-start mb-4">
                    <div>
                        <h1 class="text-2xl font-bold text-slate-800">{{ $pdfDocument->name }}</h1>
                    ...
                    <span class="px-3 py-1 rounded-full text-sm font-semibold
                        @if($pdfDocument->status === 'uploaded') bg-gray-100 text-gray-800
                        @elseif($pdfDocument->status === 'in_progress') bg-blue-100 text-blue-800
