                    ...
                    @forelse($pdfs as $pdf)
                        <tr class="hover:bg-gray-50">
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">
                                <a href="{{ route('pdf.detail', $pdf) }}" class="text-slate-700 hover:text-slate-900 hover:underline">{{ $pdf->name }}</a>
                            </td>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                <a href="{{ route('pdf.detail', $pdf) }}" class="text-slate-600 hover:text-slate-900 mr-3">Detail</a>
                                <a href="{{ route('pdf.download', $pdf) }}" class="text-slate-600 hover:text-slate-900 mr-3">Stáhnout</a>
